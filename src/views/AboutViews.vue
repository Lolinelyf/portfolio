    ...
    <div :class="$style.about">
      <div :class="$style.info">
        ...
        <div :class="$style.history">
          <p>
            Я начинающий Frontend-разработчик из красивого города Ставрополя,
            Россия.
          </p>
          <p>
          ...
          <p>
            Мой путь в мире Frontend-разработки только начинается. Я полон
            энтузиазма и готовности к постоянному росту.
          </p>
        </div>
